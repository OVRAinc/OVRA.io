			...
			<main>
				...
				>
					...
					<motion.div variants={fadeInUp} className="my-24">
						<div className="grid grid-cols-2 justify-items-center gap-x-16">
							<div className="sm:grid hidden grid-cols-1 gap-y-2 md:gap-8 md:grid-cols-2 w-min-[34rem]">
								{photoList.map((photo, i) => (
									<img
										className="w-min-[34rem]"
										key={photo}
										src={`/about/${photo}`}
										alt={""}
									/>
							...
							<div className="max-w-[64rem] col-span-2 sm:col-span-1">
								<h2 className="text-left text-7xl md:text-6xl font-bold uppercase pb-16">
									What are we doing?
								</h2>
